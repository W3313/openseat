...
1. Live mode has never run against the real endpoints, and the deploy path ships only the fictional demo. "Launch" means building the real-data publish path, not flipping an env var.
